...
const iam = () => {
  return `
    <div class="iam" style="background: linear-gradient(0deg,rgba(0,0,0,.7),rgba(19,19,19,.7) 75%,rgba(33,33,33,.7)),url(${background}); background-position: center;background-attachment: scroll; background-repeat: no-repeat;">
      <h1>Hey, I'm Jhon</h1>
      <h2>Front End developer</h2>
      <div class="iam__divider-container">
